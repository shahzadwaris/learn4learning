   ...
   $iid=Auth::User()->id;
    ...
    public function studentHome(){
                        ...
                        ->get();
                         ...
                         // ->join('users', 'users.id', 'student_lessons.teacher_id')
...
->get();
    ...
    ->get();
      ...
      $getuserimg=DB::table('users')
              ...
              ->select('users.thumbnail as userthamnail', 'lessons.title', 
                'lessons.description', 'lessons.date',  
                'lessons.thumbnail','subjects.name as subjectname', 'lessons.time', 'lessons.id as lessonsId' ,'lessons.user_id as teacher_id')->get();
 ...
 $counthomework=DB::table('homework')
                               ...
                               ->join('lessons', function ($join) {
                                ...
                                ->select('subjects.id as subject_id', 'subjects.name as subjectname',
                                          'lessons.id as lessons_id','lessons.title as lessons_title', 'lessons.description as lessons_des',
                                           'homework.*', 'homework.date as Duedate' , 'lessons.thumbnail as lesson_thum',  'lessons.document as lessonsDoc')
                                ->limit(10)
                                ->get();
...
$countlessons=count($counthomework);
 ...
 $teacherhomeworkdetail=DB::table('homework')
        ...
        return view('frontend.pages.students.student-home')->with(['getuserimg'=>$getuserimg,
          'Book'=> $Book,
           'getdata'=> $getdata,
...
$student_iid=Auth::User()->id;
 ...
 $teacherhomeworkdetail=DB::table('subjects')
                               ...
                               ->join('users', 'users.id', '=', 'homework.teacher_id')
                                ...
                                ->OrderBy('homework.id', 'DESC')
                                ->select('subjects.name as subname', 'subjects.id as subject_iid','homework.id as homeWorkId' ,'homework.title as homeworkTitle',
                                 'homework.discription as homeworkdes', 'homework.date as homeDate', 'homework.document as homeworkDocument',  'lessons.id as lesson_id', 'lessons.title as Tilte_Lessons',
                                 'lessons.Description as Lesson_des', 'lessons.date as LesonDate', 'users.fname' )
                                ->limit(10)
                                ->get();
...
public function viewHomework($id){
 ...
 $teacherhomeworkdetaild=DB::table('subjects')
                               ...
                               ->join('users', 'users.id', '=', 'homework.teacher_id')
                                ...
                                ->select('subjects.name as subname', 'subjects.id as subject_iid', 'student_lessons.techer_id as student_lessonsTeacherId', 'homework.id as homeWorkId','homework.title as homeworkTitle', 'homework.document as h_docuent',
                                 'homework.discription as homeworkdes', 'homework.date as homeDate', 'homework.document as homeworkDocument',  'lessons.id as lesson_id', 'lessons.title as Tilte_Lessons',
                                 'lessons.Description as Lesson_des', 'lessons.*', 'lessons.thumbnail', 'lessons.date as LesonDate', 'users.fname','users.id as UserId', 'homework.teacher_id as teacher_ids')
                                ->limit(10)
                                ->first();
