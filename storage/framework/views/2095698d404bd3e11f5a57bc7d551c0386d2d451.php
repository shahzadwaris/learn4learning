                                        ...
                                        <div class="step">
                                            <div class="form-group">
                                                <label class="container_check version_2"><?php echo e($sub['name']); ?>
                                                    ...
                                                    <input type="checkbox"  name="subject[]" value="<?php echo e($sub['id']); ?>"  data-toggle="collapse" data-target="#a<?php echo e($sub->id); ?>" >
                                                            ...
                                                            <tr>
                                                                <td>
                                                                    <label class="container_check version_2" style="border:unset!important;">Primary
                                                                        <input type="checkbox"  name="subject_<?php echo e($sub['id']); ?>_level[]" value="1">
                                                                        <span class="checkmark"></span>
                                                                    </label>
                                                                </td>
                                                                <td>
                                                                    <label class="container_check version_2" style="border:unset!important;">Secondary
                                                                        <input type="checkbox"  name="subject_<?php echo e($sub['id']); ?>_level[]" value="2">
                                                                        <span class="checkmark"></span>
                                                                    </label>
                                                                </td>
                                                            </tr>
                                                            <tr>
                                                                <td colspan="2">
                                                                    <label class="container_check version_2" style="border:unset!important;">Further Education
                                                                        <input type="checkbox"  name="subject_<?php echo e($sub['id']); ?>_level[]" value="3">
                                                                        <span class="checkmark"></span>
                                                                    </label>
                                                                </td>
                                                            </tr>
...
<?php echo $__env->make('layouts.teachersmaster', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/bladocou/learning.rkixtech.com/resources/views/auth/teachers/teacher-subjects.blade.php ENDPATH**/ ?>