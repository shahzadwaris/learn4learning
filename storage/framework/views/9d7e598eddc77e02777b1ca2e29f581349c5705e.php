...
<section id="slider-part" class="slider-active">
    <div class="single-slider slider-4 bg_cover pt-150" id="howitwork-slider-top"
        style="background-repeat: no-repeat; background:linear-gradient( rgba(0, 0, 0, 0.5) 100%, rgba(0, 0, 0, 0.5)100%), url(<?php echo e(asset('asset/images/howitworks/banner.png')); ?>"
        id="howitwork-slide">
        <div class="container">
        ...
        <div class="row">
            <div class="col-md-3.5 box_icon" style="padding: 10px">
                <a href="#">
                    <span class="single-category text-center color-1">
                        <span class="icon">
                            <img src="<?php echo e(asset('asset/images/howitworks/easy.png')); ?>" alt="Icon">
                        </span>
                        <span class="cont">
            ...
            <div class="col-md-3.5 box_icon" style="padding: 10px">
                <a href="#">
                    <span class="single-category text-center color-1" id="how-it-work-free">
                        <span class="icon">
                            <img src="<?php echo e(asset('asset/images/howitworks/free.png')); ?>" alt="Icon">
                        </span>
                        <span class="cont">
                            <span>FREE</span>
                        </span>
            ...
            <div class="col-md-3.5 box_icon" style="padding: 10px" id="tutoring">
                <a href="#">
                    <span class="single-category text-center color-1">
                        <span class="icon">
                            <img src="<?php echo e(asset('asset/images/howitworks/tutoring.png')); ?>" alt="Icon">
                        </span>
                        <span class="cont">
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-lg-6 offset-lg-1 how-it-wor-sec-1-right">
                <img src="<?php echo e(asset('asset/images/howitworks/kid.png')); ?>" alt="">
            </div>
        </div> <!-- row -->
    </div> <!-- container -->
</section>
    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-6 offset-lg-1 how-it-wor-sec-2-left">
                <img src="<?php echo e(asset('asset/images/howitworks/kid-2.png')); ?>" alt="">
            </div>
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-lg-6 offset-lg-1 how-it-wor-sec-3-right">
                <img src="<?php echo e(asset('asset/images/howitworks/kid-3.png')); ?>" alt="">
            </div>
        </div> <!-- row -->
    </div> <!-- container -->
</section>
                ...
                <div class="col-xl-7 col-lg-9">
                    <div class="slider-cont slider-cont-4 text-center">
                        ...
                        <a data-animation="fadeInUp" data-delay="2s" class="main-slider-btn  bottom-slider-std-par"
                            href="<?php echo e(route('login')); ?>">I AM A STUDENT/PARENT</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                        <a data-animation="fadeInUp" data-delay="2s" class="main-slider-btn bottom-slider-teach"
                            href="<?php echo e(route('login')); ?>" style="">I AM A TEACHER</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                    </div>
                </div>
            </div> <!-- row -->
        </div> <!-- container -->
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/mahad/Desktop/learnforlearning/resources/views/frontend/pages/howitworks.blade.php ENDPATH**/ ?>