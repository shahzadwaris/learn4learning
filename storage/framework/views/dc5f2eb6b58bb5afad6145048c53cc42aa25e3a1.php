  ...
  <button type="button" class="close" data-dismiss="alert" aria-label="Close">
    <span aria-hidden="true">&times;</span>
             ...
             <?php endif; ?>
                                    ...
                                    <div style="width:100%;">
                                        <input type = "email" class="_inputwidth" name="email" placeholder="Email Address" required="true">
                                    </div>
                                    <div style="width:100%;">
                                        <input type = "password" class="_inputwidth" name="password" placeholder="Write your Password" required="true">
                                    </div>
                                    <div style="width:100%;">
                                        <input class="form-check-input" type="checkbox" name="remember_me" value="" id="invalidCheck">
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/bladocou/learning.rkixtech.com/resources/views/auth/login.blade.php ENDPATH**/ ?>