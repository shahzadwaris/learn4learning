                    ...
                    <div class="col-lg-12">
                        <nav class="navbar navbar-expand-lg">
                            ...
                            <div class="collapse navbar-collapse sub-menu-bar" id="navbarSupportedContent">
                                <ul class="navbar-nav ml-auto">
                                    <li class="nav-item">
                                        <a class="active" href="<?php echo e(route('studentHome')); ?>">Home</a>
                                    </li>
                                    <li class="nav-item">
                                        <a href="<?php echo e(route('student_schedule')); ?>  ">MY SCHEDULE</a>
                                    </li>
                                    <li class="nav-item">
                                        <a href="<?php echo e(route('My_subjects')); ?>">MY SUBJECTS</a>
                                    </li>
                                    <li class="nav-item">
                                        <a href="<?php echo e(route('studetnsHomeWork')); ?>">MY HOMEWORK</a>
                                    </li>
                                    <li class="nav-item">
...
</html><?php /**PATH C:\wamp64\www\learnforlearning\resources\views/layouts/masterStudent.blade.php ENDPATH**/ ?>