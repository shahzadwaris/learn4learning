        ...
        <div class="container" style="width:80%">
            ...
            <div class="main-cont">
                ...
                <div class="row">
                    ...
                    <div class="col-md-6 d-flex align-items-center justify-content-center <?php echo e($key%2==0 ? '_regSubLP': '_regSubRP'); ?>">
                                    ...
                                    <div class="step">
                                        <div class="form-group">
                                            <label class="container_check version_2">Other
                                                <input type="checkbox"  name="subjects[]" value="00_other_id"  data-toggle="collapse" data-target="#a00_other_id" >
                                                <span class="checkmark"></span>
...
<?php echo $__env->make('layouts.teachersmaster', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\wamp64\www\learnforlearning\resources\views/auth/students/student-subject.blade.php ENDPATH**/ ?>