 ...
 -->                          <th scope="col"></th>
                      ...
                      <tbody>
                        <tr>
                          ...
                          <td>
                        <a href="<?php echo e(route('assingachevment', [$getmystydentrecord->sub_id, $getmystydentrecord->User_id, $getmystydentrecord->homeworkid])); ?>">
                            <button type="button" class="btn btn-indigo btn-sm m-0" id="view-lesson-btn">VIEW HomWork</button></a> </td>
...
<?php echo $__env->make('layouts.teachersmaster', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\learn4learning\resources\views/frontend/pages/teachers/ViewSepStudents.blade.php ENDPATH**/ ?>