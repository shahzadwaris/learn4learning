                            ...
                            <div style="display:flex;width:100%;">
                                <form action="<?php echo e(url('get-teacher-profile')); ?>" method="post" enctype="multipart/form-data">
                                    ...
                                    <div class="file-field">
                                        ...
                                        <input type="file" name="thumbnail"   onchange="readURL(this);"  required="true" accept="image/x-png,image/gif,image/jpeg">
                                        <div id="blah"></div>
                                        </div>
                                    ...
                                    <div class="d-flex" style="width: 100%">
                                        ...
                                        <div class="custom-control custom-radio ml-3">
                                            <input type="radio" class="custom-control-input" value="1" id="defaultUnchecked" name="fof_session">
                                            <label class="custom-control-label gray_font" for="defaultUnchecked">Yes</label>
                                        </div>
                                        <div class="custom-control custom-radio ml-2">
                                            <input type="radio" class="custom-control-input" value="0" id="defaultChecked" name="fof_session" checked="">
                                    ...
                                    <button type="button" class="btn btn-primary active _skip_btn" style=" background-color: #ff000000!important;box-shadow: unset;">
                                        <a href="/login" style="color: gray;text-decoration: underline;"><b>SKIP</b></a></button>
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/bladocou/learning.rkixtech.com/resources/views/auth/teachers/teacher-profile.blade.php ENDPATH**/ ?>