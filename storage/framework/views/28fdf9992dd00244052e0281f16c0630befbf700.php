...
<?php $__env->startSection('content'); ?>
    ...
    <section id="slider-part" class="slider-active">
        <div class="single-slider slider-4 bg_cover pt-150" style="padding-bottom: 149px;padding-top: 172px;background-repeat: no-repeat; background:linear-gradient( rgba(0, 0, 0, 0.5) 100%, rgba(0, 0, 0, 0.5)100%), url(<?php echo e(asset('asset/images/students/banner.png')); ?>">
            <div class="container" >
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-6 offset-lg-1 std-sec1-right">
                    <img src="<?php echo e(asset('asset/images/students/choose-subjects.png')); ?>" alt="">
                </div>
            </div> <!-- row -->
        </div> <!-- container -->
    </section>
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-6 offset-lg-1 std-sec2-left" >
                    <img src="<?php echo e(asset('asset/images/students/inspirational-teacher.png')); ?>" alt="">
                </div>
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-6 offset-lg-1 std-sec4-left" >
                    <img src="<?php echo e(asset('asset/images/students/ask-questions.png')); ?>" alt="">
                </div>
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-5 std-sec5-right">
                    <img src="<?php echo e(asset('asset/images/students/learn4learning.png')); ?>" alt="">
                </div>
            </div> <!-- row -->
        </div> <!-- container -->
    </section>
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-2 std-sec6-very-right">
                    <img src="<?php echo e(asset('asset/images/students/student-last-sec.png')); ?>" alt="">
                </div>
            </div> <!-- row -->
        </div> <!-- container -->
    </section>
    ...
    <section id="slider-part" class="slider-active">
        <div class="single-slider slider-4 bg_cover pt-150" style="background-repeat: no-repeat; padding-bottom: 40px; padding-top: 25px; background:linear-gradient( rgba(0, 0, 0, 0.5) 100%, rgba(0, 0, 0, 0.5)100%), url(<?php echo e(asset('asset/images/slider/banner.jpg')); ?>">
            <div class="container">
                <div class="row justify-content-center">
                    <div class="col-xl-7 col-lg-9">
                        <div class="slider-cont slider-cont-4 text-center">
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\learn4learning\resources\views/frontend/pages/students.blade.php ENDPATH**/ ?>