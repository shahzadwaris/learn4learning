...
<link rel="stylesheet" href="<?php echo e(asset('asset/css/donate.css')); ?>">
    ...
    <section id="slider-part" class="slider-active">
        <div class="single-slider slider-4 bg_cover pt-150" style="background-repeat: no-repeat; background:linear-gradient( rgba(0, 0, 0, 0.5) 100%, rgba(0, 0, 0, 0.5)100%), url(<?php echo e(asset('asset/images/donate/banner.jpg')); ?>">
            <div class="container" >
    ...
    <section id="teachers-part" class="pt-70 pb-120">
        <div class="container" id="container">   
            ...
            <form action="<?php echo e(route('stirpepaymentgatway')); ?>" method="post">  
            <?php echo csrf_field(); ?>     
        ...
        <?php endif; ?>
                ...
                <div class="row" id="payment-btns">
                    ...
                    <div class="row" id="payment-pics">
                        <div class="col-md-4"><button type="submit" style="border:none; cursor:pointer"> <img src="<?php echo e(asset('asset/images/donate/visa.jpg')); ?>"/></button></div>
                        <div class="col-md-4"><a href="#"><img src="<?php echo e(asset('asset/images/donate/paypal.jpg')); ?>"/></a></div>
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/bladocou/learning.rkixtech.com/resources/views/frontend/pages/donate.blade.php ENDPATH**/ ?>