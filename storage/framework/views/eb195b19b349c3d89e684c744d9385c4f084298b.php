            ...
            <div class="col-md-6">
                <div class="card card-bordered">
                    ...
                    <div class="ps-container ps-theme-default ps-active-y" id="chat-content" style="overflow-y: scroll !important; height:400px !important;">
                        <div class="media media-chat"> <img class="avatar" src="<?php echo e(asset('asset/images/student-homepage/child.jpg')); ?>" alt="...">
                            <div class="media-body">
                              
                            </div>
                        </div>
                        <?php $__currentLoopData = $studentMsg; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $studentMsg): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div class="media media-meta-day"><?php echo $date=date("m/d");  ?></div>
                        <div class="media media-chat media-chat-reverse">
                            <div class="media-body">
                                <p><?php echo e($studentMsg->messages); ?></p>
                                        
                                <p class="meta"><time datetime="2018"><?php echo date("H:i:s");?></time></p>
                            </div>
                        </div>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                      <?php $__currentLoopData = $teacherMSg; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $teacherMSg): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                  <div class="media media-chat"> <img class="avatar" src="<?php echo e(asset('asset/images/student-homepage/child.jpg')); ?>" alt="...">
                            <div class="media-body">
                                <p><?php echo e($teacherMSg->messages); ?></p>
                                <p class="meta"><time datetime="2018"><?php echo date("H:i:s");?> </time></p>
                            </div>
                        </div>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
...
<?php echo $__env->make('layouts.teachersmaster', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\learn4learning\resources\views/frontend/pages/teachers/MessagesStudent.blade.php ENDPATH**/ ?>