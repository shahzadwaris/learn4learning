                    ...
                    <div class="form-parts">
                        <p class="level-heading gray_font" >Choose Lesson Category</p>
                            <select class="selectpicker" name="subject" required="true">
                                <option value="">Select any Subjec               </option>
                                ...
                                <option value="<?php echo e($subj->id); ?>"><?php echo e($subj->name); ?></option>
    ...
    <section id="add-level-data">
        <div class="container Ccontainer">
            <div class="form-group">
                ...
                <input type="text" class="form-control" name="title" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="" required="true">
            </div>
            <div class="form-group">
                <label for="exampleFormControlTextarea1">Description</label>
                <textarea class="form-control" name="description" id="exampleFormControlTextarea1" rows="8" required="true"></textarea>
            </div>
            ...
            <div class="row my-5">
                ...
                <div class="col-sm-4 gray_font">
                    <div class="input-group mb-3">
                        ...
                        <input type="date" class="form-control" name="registration_date" id="registration-date" required="" style="max-width: 170px">
                ...
                <div class="col-sm-8 gray_font">
                    <div class="input-group mb-3">
                        ...
                        <input type="time" class="form-control" name="registration_time" id="registration-time" required="" style="max-width: 170px">
                        <div class="input-group-append">
                          <span class="input-group-text" style="background-color: #045375;color: #fff"><i class="fas fa-chevron-down"></i></span>
                        </div>
                    </div>
                                 ...
                                 <div>
                                    <p class="addfiles-add-lesson">ADD VIDEO (LINK)</p>
                                        <div class=" d-flex justify-content-center">
                                            ...
                                            <input type="textarea" name="video" class="form-control" placeholder="https://www.example.com/">
                                        </div>
                                    </p>
                                </div>
                            ...
                            <div class="content align-items-center d-flex">
                                ...
                                <div class="text-center" id="_container">
                                    ...
                                    <div class="image-upload">
                                        ...
                                        <input name="photo" id="file-input3" type="file" id="profile-img" onchange="readURL(this);"   required="true" accept="image/x-png,image/gif,image/jpeg" />
                                    </div>
                                </div>
          ...
          <input type="hidden" name="level_id" value="<?php echo e($levels); ?>">
...
<?php echo $__env->make('layouts.teachersmaster', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/bladocou/learning.rkixtech.com/resources/views/frontend/pages/teachers/add-lesson.blade.php ENDPATH**/ ?>