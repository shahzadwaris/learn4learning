...
<style type="text/css">
    ...
    <section id="slider-part" class="slider-active">
        <div class="single-slider slider-4 bg_cover pt-150" style="padding-top: 238px;padding-bottom: 238px;background-repeat: no-repeat; background:linear-gradient(rgb(0 0 0 / 17%) 100%, rgb(0 0 0 / 16%) 100%), url(<?php echo e(asset('asset/images/teacher-homepage/teaching_banner.jpg')); ?>">
            <div class="container" >
            ...
            <div class="col-lg-6 col-sm-12 col-xs-12" id="std-dashboard-left">
                ...
                <div class="row">
                    <div class="col-lg-4 col-sm-12 col-xs-12">
                        <img src="<?php echo e(url('/storage/images/'. (!empty($usersimgg[0]->thumbnail) ? $usersimgg[0]->thumbnail : 'default.png') )); ?>" alt="stud-profile-pic" >
                    </div>
            ...
            <div class="col-lg-6 col-sm-12 col-xs-12"  id="std-dashboard-right">
                <div class="row">
                    ...
                    <div class="col-lg-6 col-sm-6 col-xs-12" id="schedule-div">
                        <a href="<?php echo e(route('teacherSchedule')); ?>"><img src="<?php echo e(asset('asset/images/student-homepage/schedule.png')); ?>" alt=""></a>
                ...
                <div class="row">
                    <div class="col-lg-6 col-sm-6 col-xs-12" id="grades-div">
                        <a href="<?php echo e(route('teacherAddLesson')); ?>"><img src="<?php echo e(asset('asset/images/teacher-homepage/add-lesson-teacher.png')); ?>" alt=""></a>
                        <p>Add<br>Lesson</p>
                    </div>
                    <div class="col-lg-6 col-sm-6 col-xs-12" id="homework-div">
                        <a href="<?php echo e(route('teacherHomeWork')); ?>"><img src="<?php echo e(asset('asset/images/student-homepage/homework.png')); ?>" alt=""></a>
                    ...
                    <div class="card">
                        ...
                        <a href="#">
                            <div class="rounded-bottom mdb-color lighten-3 text-center pt-3">
                                  <h4 class="card-title"><?php echo e($books2[0]->date); ?></h4>
                            </div>
                        </a>
                        <!-- Card content -->
                        <div class="card-body">
                        <!-- Title -->
                     <?php $__currentLoopData = $sepbookingss; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $bookingg): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
...
->get();
         ...
         <div class="col-4">
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                        <!-- Title -->
                    <?php $__currentLoopData = $sepbooking2; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $bookingg): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <p class="teach-shed-card-content"> <?php echo e($bookingg->time); ?>&nbsp;&nbsp;&nbsp;<?php echo e($bookingg->sub_name); ?></p>
                                 <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                         <br>
...
?>
                <div class="col-4">
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                        <!-- Title -->
                     <?php $__currentLoopData = $sepbookingss4; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $bookingg): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <p class="teach-shed-card-content"> <?php echo e($bookingg->time); ?>&nbsp;&nbsp;&nbsp;<?php echo e($bookingg->sub_name); ?></p>
                                 <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                         <br>
...
->get();
         ...
         <div class="col-4">
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                        <!-- Title -->
                    <?php $__currentLoopData = $sepbooking4; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $bookingg): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <p class="teach-shed-card-content"> <?php echo e($bookingg->time); ?>&nbsp;&nbsp;&nbsp;<?php echo e($bookingg->sub_name); ?></p>
                                 <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                         <br>
  ...
  ?>
          ...
          <div class="col-4">
                    ...
                    <div class="card">
                        ...
                        <!-- Card content -->
                        <div class="card-body">
                                    <?php $__currentLoopData = $sepbooking5; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $bookingg): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <p class="teach-shed-card-content"> <?php echo e($bookingg->time); ?>&nbsp;&nbsp;&nbsp;<?php echo e($bookingg->sub_name); ?></p>
                                 <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                         <br>
...
?>
                <div class="col-4">
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                        <!-- Title -->
                     <?php $__currentLoopData = $sepbookings6; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $bookingg): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <p class="teach-shed-card-content"> <?php echo e($bookingg->time); ?>&nbsp;&nbsp;&nbsp;<?php echo e($bookingg->sub_name); ?></p>
                                 <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                         <br>
...
->get();
         ...
         <div class="col-4">
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                        <!-- Title -->
                    <?php $__currentLoopData = $sepbooking7; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $bookingg): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <p class="teach-shed-card-content"> <?php echo e($bookingg->time); ?>&nbsp;&nbsp;&nbsp;<?php echo e($bookingg->sub_name); ?></p>
                                 <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                         <br>
  ...
  ?>
          ...
          <div class="col-4">
                    ...
                    <div class="card">
                        ...
                        <!-- Card content -->
                        <div class="card-body">
                                    <?php $__currentLoopData = $sepbooking8; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $bookingg): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <p class="teach-shed-card-content"> <?php echo e($bookingg->time); ?>&nbsp;&nbsp;&nbsp;<?php echo e($bookingg->sub_name); ?></p>
                                 <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                         <br>
        ...
        <?php } ?>    
                ...
                <div class="col-12 col-12 justify-content-center" id="donate-register-btn-div" style="margin-top: 10px">
                    <a data-animation="fadeInUp" data-delay="2s" class="main-slider-btn2" href="<?php echo e(url('teacher-schedule')); ?>" id="donate-register-btn">SEE ALL</a>
                </div>
                            ...
                            <div class="item">
                                <div class="pad15">
                                    <div class="card postion-relative">
                                        <img class="card-img" src="  <?php echo e(url('/storage/images/'.$teacherhomeworkdetail->lesson_thum)); ?>" alt="Bologna" height="100%">
                                        <div class="card-img-overlay text-white d-flex flex-column justify-content-center">
                                            <div class="topright"><span class="exclamation-para"><?php echo e($teacherhomeworkdetail->Duedate); ?></span><i class="fa fa-exclamation" aria-hidden="true" id="exclamation-icon"></i></div>
                                        ...
                                        <a data-animation="fadeInUp" data-delay="2s" class="main-slider-btn2 postion-absolute" id="schedule-btn-teach" href="#" style="bottom:0px;width: 100%;position:absolute;"><?php echo app('translator')->get('teacherhome.LEARN_MORE'); ?></a>
                                    </div>
                                </div>
                            </div>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
...
<?php echo $__env->make('layouts.teachersmaster', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/bladocou/learning.rkixtech.com/resources/views/frontend/pages/teachers/teacher-homepage.blade.php ENDPATH**/ ?>