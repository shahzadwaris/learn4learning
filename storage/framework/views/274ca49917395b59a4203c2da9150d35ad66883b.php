...
<?php $__env->startSection('content'); ?>
    ...
    <section id="slider-part" class="slider-active">
        <div class="single-slider slider-4 bg_cover pt-150" id="howitwork-slider-top" style="background-repeat: no-repeat; background:linear-gradient( rgba(0, 0, 0, 0.5) 100%, rgba(0, 0, 0, 0.5)100%), url(<?php echo e(asset('asset/images/howitworks/banner.png')); ?>" id="howitwork-slide">
            <div class="container">
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/bladocou/learning.rkixtech.com/resources/views/frontend/pages/howitworks.blade.php ENDPATH**/ ?>