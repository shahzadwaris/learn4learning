               ...
               <div class="col-md-6 col-sm-12 col-xs-12">
                   <div class="row">
                       <div class="col-12 media">
                           <iframe width="420" height="345" src="https://www.youtube.com/embed/<?php echo e($lesssonDetail['0']['video']); ?>" allowfullscreen>
                           </iframe>
                       </div>
                   </div>
               </div>
               ...
               <div class="col-md-6 col-sm-12 col-xs-12">
                    <div class="row">
                        <div class="col-md-9 col-sm-12 col-xs-12">
                            <h4><?php echo e($lesssonDetail['0']['title']); ?></h4>
                            <p>Live Date:<?php echo e($lesssonDetail['0']['date']); ?><br>
                                Time:<?php echo e($lesssonDetail['0']['time']); ?></p>
                            <div class="row">
                                <div class="col-md-2">
                                    <img src="<?php echo e(url('/storage/images/'.$lesssonDetail['0']['teacher_thumbnail'])); ?>">
                                </div>
                                <div class="col-md-5">
                                    <p><?php echo e($lesssonDetail['0']['teacher_fname']); ?>-<?php echo e($lesssonDetail['0']['teacher_lname']); ?></p>
                                </div>
                                <div class="col-md-5">
                                    <a href="<?php echo e(route('teacherProfile',$lesssonDetail[0]['user_id'])); ?>" class="profile-btn" style="">VIEW PROFILE</a>
                    ...
                    <div class="row">
                        <div class="col-12">
                            <p data-animation="fadeInUp" data-delay="1.5s"><?php echo e($lesssonDetail['0']['description']); ?></p>
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/bladocou/learning.rkixtech.com/resources/views/frontend/pages/students/student-lesson-page.blade.php ENDPATH**/ ?>