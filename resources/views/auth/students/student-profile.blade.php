                            ...
                            <div style="display:flex;width:100%;">
                                <form action="{{ url('/get-profile') }}" method="post" enctype="multipart/form-data">
                                    ...
                                    <div style="width:100%;">
                                        ...
                                        <input class="_inputwidth" name="description" autofocus required="true" placeholder="Description">
                                    </div>
                                    <div style="width:100%;">
                                    ...
                                    <button  class="btn btn-primary active _skip_btn" style=" background-color: #ff000000!important;box-shadow: unset;"><a href="/login" style="color: gray;text-decoration: underline;"><b>SKIP</b></a></button>
