                ...
                <div class="">
                    <table class="table tablesorter " id="">
                        ...
                        @foreach($user_data as $data)
                                    ...
                                    <td>{{$data->name}}</td>
                                    <td>
                                        <a href="mailto:admin@black.com">{{$data->email}}</a>
                                    </td>
...
{{--                                                    <a class="dropdown-item" onclick="orderDetail({{$data->id}})" href="{{route('editUser',[$data->id])}}">Edit</a>--}}
                                                    <a class="dropdown-item" onclick="orderDetail({{$data->id}})" href="#">Edit</a>
                                                    <a class="dropdown-item" href="{{route('editUser',[$data->id])}}">Delete</a>
                                                </div>
                                            </div>
                                    </td>
                                </tr>
