...
@section('content')
    ...
    <section id="slider-part" class="slider-active">
        <div class="single-slider slider-4 bg_cover pt-150" style="background-repeat: no-repeat; background:linear-gradient(rgb(0 0 0 / 23%) 100%, rgba(0, 0, 0, 0.5) 100%), url({{asset('asset/images/slider/banner.jpg')}}">
            <div class="container">
                <div class="row justify-content-center">
                    <div class="col-xl-7 col-lg-9">
                        <div class="slider-cont slider-cont-4 text-center">
                           ...
                           @if(!Auth::check())
                            <a data-animation="fadeInUp" data-delay="2s" class="main-slider-btn" href="{{ route('login') }}" >@lang('welcome.I_A_STUDENT')</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                            <a data-animation="fadeInUp" data-delay="2s" class="main-slider-btn2" href="{{ route('login') }}" style="background-color: #036893;">            @lang('welcome.I_TEACHER')</a>
                            @endif
                        </div>
                    </div>
                </div> <!-- row -->
        ...
        <div class="row">
            <div class="col-lg-4 col-md-6 col-sm-6" style="padding: 0px !important;" >
                ...
                <div class="card card-image prim-second"
                    ...
                    <div class="text-white text-center d-flex align-items-center rgba-black-strong py-5 px-4">
                        ...
                        <h3 class="card-title pt-2"><strong style="color: white;line-height: 100px;font-size: 52px;font-weight: 500;">@lang('welcome.PRIMARY')</strong></h3>
            ...
            <div class="col-lg-4 col-md-6" style="padding: 0px !important;">
                ...
                <div class="card card-image prim-second"
                    ...
                    <div class="text-white text-center d-flex align-items-center rgba-black-strong py-5 px-4">
                        ...
                        <h3 class="card-title pt-2"><strong style="color: white;line-height: 100px;font-size: 52px;font-weight: 500;">@lang('welcome.SECONDARY')</strong></h3>
            ...
            <div class="col-lg-4 col-md-12" style="padding: 0px !important;">
                ...
                <div class="card card-image prim-second"
                    ...
                    <!-- Content -->
                    <div class="text-white text-center d-flex align-items-center rgba-black-strong py-5 px-4">
                        <h3 class="card-title pt-2"><strong style="color: white;line-height: 50px;font-size: 52px;font-weight: 500;">@lang('welcome.FURTHER_EDUCATION')</strong></h3>
                    </div>
                </div>
                <!-- Card -->
            </div>
    ...
    <section id="about-part" class="about-tow pt-65">
        ...
        <h5 style="text-align: center;color: #006796;font-size: 28px;letter-spacing: 5px;">@lang('welcome.Find_A_Course')</h5>
        <!-- container -->
    </section>
    ...
    <section style="background:linear-gradient(rgba(0, 0, 0, 0.5) 100%, rgba(0, 0, 0, 0.5) 100%), url({{asset('asset/images/browsebysubject/browsebysubject.png')}}">
        <h5 style="text-align: center;color: #ffffff;font-size: 28px;letter-spacing: 5px;padding: 60px 0px 30px 0px;">@lang('welcome.browseBySubject')</h5>
  ...
  <button type="button" class="close" data-dismiss="alert" aria-label="Close">
    <span aria-hidden="true">&times;</span>
     ...
     @endif
        ...
        <div class="col-6"><h4 class="card-title lessone-date">{{$leson->date}}<br>
        {{$leson->time}}</h4>
        </div>
        <div class="col-6">
        <div class="review">
...
<a data-animation="fadeInUp" data-delay="2s" class="main-slider-btn" href="{{route('login')}}" style="background: #7acdf0;color: white;font-weight: 500;display: block;">ADD TO CALENDAR</a>
                                    @endif
            @if(Auth::check())
...
<a data-animation="fadeInUp" data-delay="2s" class="main-slider-btn" href="{{ route('addToCalender', [$leson->lessonsId, $leson->teacher_id, $leson->subjects_id])}}" style="background: #7acdf0;color: white;font-weight: 500;display: block;">ADD TO CALENDAR</a>
