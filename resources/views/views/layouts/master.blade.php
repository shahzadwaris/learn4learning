                    ...
                    <div class="col-lg-4 col-md-6">
                        <div class="">
                            <div class="row">
                                <div class="col-4">
                                    <div class="logo">
                                        <a href="{{route('home')}}"><img src="{{asset('asset/images/footer-logo.png')}}" alt="Logo"></a>
                                    </div>
                                </div>
                                <div class="col-8">
                                    <ul>
                                        <p style="color: white">Powered by Hot Dog Solutions</p>
                                        <li><a href="about.html">Contact Us</a></li>
                                        <li><a href="courses.html">Visit Our Website</a></li>
