...
<section id="teachers-part" class="pt-70 pb-120" style="margin-top:100px">
 ...
 --> @if(Session::get('success_message'))
                    ...
                    <form accept-charset="UTF-8" action="{{route('stirpepaymentgatway')}}" class="require-validation"
                        ...
                        <div class='form-row'>
                            <div class='col-md-12'>
                                <div class='form-control total btn btn-info' style="margin-top:20px">
                                    Total: <span class='amount'>{{$donate}}</span>
                                </div>
                            </div>
                        </div>
                        <div class='form-row'>
                        ...
                        <div class='form-row'>
                            <div class='col-md-12'>
                                <a style="background-color:#ffc10e" href="{{route('donate')}}"
