        ...
        <div class="row d-flex justify-content-center text-center h-100">
            <div class="col-6" id="std-dashboard-left">
                <div class="stu-home-dash-head-div">
                    <p class="stu-home-dash-head-head text-center">{{$db[0]->fname}}</p>
                    <hr>
                </div>
                <div class="row">
                    <div class="col-12">
                        <img src="{{url('/storage/images/'.$db[0]->thumbnail)}}" alt="" id="stud-profile-pic">
                    </div>
                    <div class="col-8">
                        <p class="stud-name text-center">{{$db[0]->fname}}-{{$db[0]->lname}}</p>
                        <p class="stud-date text-center">{{$db[0]->email}}</p><br><br>
                             <a data-animation="fadeInUp" data-delay="2s" class="main-slider-btn2" href="<?php echo route('messages',['id'=>$db[0]->id])?>" id="donate-register-btn">Contact</a>
                        <p class="stud-date ">
