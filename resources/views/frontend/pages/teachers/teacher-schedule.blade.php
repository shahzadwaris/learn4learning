        ...
        <div class="single-slider slider-4 bg_cover pt-150" style="background-repeat: no-repeat; background:linear-gradient( rgba(0, 0, 0, 0.5) 100%, rgba(0, 0, 0, 0.5)100%), url({{asset('asset/images/student-lesson-search/banner.jpg')}}">
            <div class="container">
                ...
                <div class="d-flex justify-content-center mt-4">
                    <a href="{{ url('teacher-add-lesson') }}" class="main-slider-btn2 btn btn-warning" value="" style="background-color: #FDBF11;color:white;padding:0 23px;">ADD LESSON</a>
                </div>
...
<!-- Card -->
   ...
   <section id="course-part" class="pt-115 pb-115 bg_cover" style="background-image: url(images/course/course-shape.png)">
        <div class="container ccontainer">
            ...
            <div class="row">
                @foreach($Book as $leson)
                        <div class="col-lg-4 col-md-6 col-12 position-relatiove justify-content-center d-flex">
                            <div class="_profile_image" style="{{ !empty(auth::user()->thumbnail) ? 'background-image: url(http://127.0.0.1:8000/storage/images/'.auth::user()->thumbnail.');background-size: cover;' : '' }}">
                                ...
                                <div class="thum">
                                    ...
                                    <div class="card">
                                        ...
                                        <div class="card-img-overlay text-white d-flex flex-column justify-content-center">
                                            <h4 class="card-title text-white">{{$leson->sub_name}}</h4>
                                            ...
                                            <div class="row" id="rating-date-lesson">
                                                <div class="col-6"><h4 class="card-title text-white">{{$leson->Lesson_date}}<br>
                                                        {{$leson->Lesson_time}}</h4>
                                                </div>
                                                <div class="col-6">
                                                    <div class="review">
                                                        <ul>
  ...
  <div class="cont">
                                        ...
                                        <a data-animation="fadeInUp" data-delay="2s" class="main-slider-btn" href="{{route('EditLesson', [$leson->lessonsid])}}" style="background: gray;color: white;font-weight: 500;display: block;"><i class="fas fa-edit fa-2x text-white"></i> EDIT LESSON</a>
