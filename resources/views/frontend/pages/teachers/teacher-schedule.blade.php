        ...
        <div class="row">
            ...
            <div class="col-lg-4 col-md-6 col-12 position-relatiove justify-content-center d-flex">
                <div class="_profile_image"
                    style="{{ !empty(auth::user()->thumbnail) ? 'background-image: url(http://127.0.0.1:8000/storage/images/'.auth::user()->thumbnail.');background-size: cover;' : '' }}">
    ...
    <div class="single-course-2 mt-30">
            ...
            <div class="card">
                ...
                <div class="card-img-overlay text-white d-flex flex-column justify-content-center">
                    ...
                    <div class="row" id="rating-date-lesson">
                        <div class="col-6">
                            <h4 class="card-title text-white">{{$leson->Lesson_date}}<br>
        ...
        <div class="cont">
            ...
            <a data-animation="fadeInUp" data-delay="2s" class="main-slider-btn"
                href="{{route('EditLesson', [$leson->lessonsid])}}"
