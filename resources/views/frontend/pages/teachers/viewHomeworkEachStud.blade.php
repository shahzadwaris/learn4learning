...
<!--                           <th scope="col" class="table-heading">SUbject</th>
 -->                          <th scope="col"></th>
                      ...
                      <tbody>
                        ...
                        <td>{{$getmystydentrecord->date}}</td>



               
                          <td>
                         <a href="{{route('assignGrading, [$getmystydentrecord->]')}}">
                            <button type="button" class="btn btn-indigo btn-sm m-0" id="ask-question-btn">Assign Grage</button></td>
