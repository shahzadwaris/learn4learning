            ...
            <div class="col-md-6">
                <div class="card card-bordered">
                    ...
                    <div class="ps-container ps-theme-default ps-active-y" id="chat-content" style="overflow-y: scroll !important; height:400px !important;">
                        <div class="media media-chat"> <img class="avatar" src="{{asset('asset/images/student-homepage/child.jpg')}}" alt="...">
                            <div class="media-body">
                              
                            </div>
                        </div>
                        @foreach($studentMsg as $studentMsg)
                        <div class="media media-meta-day"><?php echo $date=date("m/d");  ?></div>
                        <div class="media media-chat media-chat-reverse">
                            <div class="media-body">
                                <p>{{$studentMsg->messages}}</p>
                                        
                                <p class="meta"><time datetime="2018"><?php echo date("H:i:s");?></time></p>
                            </div>
                        </div>
                        @endforeach
                      @foreach($teacherMSg as $teacherMSg)
                  <div class="media media-chat"> <img class="avatar" src="{{asset('asset/images/student-homepage/child.jpg')}}" alt="...">
                            <div class="media-body">
                                <p>{{$teacherMSg->messages}}</p>
                                <p class="meta"><time datetime="2018"><?php echo date("H:i:s");?> </time></p>
                            </div>
                        </div>
                        @endforeach
                    ...
                    <form method="post" action="{{route('teacherSideMesages')}}">
                        @csrf
