...
<link rel="stylesheet" href="{{asset('asset/css/donate.css')}}">
    ...
    <section id="teachers-part" class="pt-70 pb-120">
        <div class="container" id="container">   
            ...
            <form action="{{route('stirpepaymentgatway')}}" method="post">  
            @csrf     
        ...
        @endif
                ...
                <div class="row" id="payment-btns">
                    ...
                    <div class="row" id="payment-pics">
                        <div class="col-md-4"><button type="submit" style="border:none; cursor:pointer"> <img src="{{asset('asset/images/donate/visa.jpg')}}"/></button></div>
