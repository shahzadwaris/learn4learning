                    ...
                    <div class="col-3 border ml-2 p-0">
                        <div class="row text-center p-0">
                            <div class="card-body  p-0 pt-4">
                                <h5 class="pb-2" style="color:#006796;">{{$lesson->lesson->subject->name}}</h5>
                                <h6 class="mb-2 text-muted" style="color:#006796;">{{$lesson->lesson->title}}</h6>
                                <p class="card-text">
                                    {{$lesson->lesson->date->format('m/d')}}<br />{{$lesson->lesson->time->format('H:i')}}
                                </p>
                                <div class="row p-0">
                ...
                <div class="row">
                    ...
                    <div class="col-md-3 w-100" style="padding: 18px;">
                        <div class="input-group mb-3">
                            <input type="date" class="form-control p-4" value="{{old('date')}}" name="date" id="date">
                        </div>
                    </div>
            ...
            <div class="row">
                ...
                <div class="col-lg-4">
                    <div class="single-course-2 mt-30">
                        <div class="thum">
                            <div class="image">
                                {{-- <img src="http://via.placeholder.com/200" alt="Course"> --}}
                                <img src="{{asset('storage/images/'.$lesson->thumbnail)}}" class="thumbnail-image"
                                    alt="Course">
                            </div>
                            <div class="price">
                                <span>Free</span>
