                  ...
                  <div class="row">
                      ...
                      <div class="col-md-8 col-sm-8 col-xs-12 justify-content-center text-center">
                          ...
                          <div class="form-group green-border-focus">
                            <textarea class="form-control" name="descriptions"  id="exampleFormControlTextarea5" required="true" rows="6"></textarea>
                          </div>
                          <div class="row">
                             ...
                             <input type="hidden" name="tea_id" value="{{$teacherhomeworkdetaild->student_lessonsTeacherId}}">
                              ...
                              <div class="col-5">
                                ...
                                <input type="file" class="filestyle" required="true" name="img" data-icon="false" accept="application/pdf,application/vnd.ms-excel" >
                                </div>
                              </div>
                              <div class="col-2">
