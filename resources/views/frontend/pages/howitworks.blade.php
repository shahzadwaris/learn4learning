...
@section('content')
    ...
    <section id="slider-part" class="slider-active">
        <div class="single-slider slider-4 bg_cover pt-150" id="howitwork-slider-top" style="background-repeat: no-repeat; background:linear-gradient( rgba(0, 0, 0, 0.5) 100%, rgba(0, 0, 0, 0.5)100%), url({{asset('asset/images/howitworks/banner.png')}}" id="howitwork-slide">
            <div class="container">
