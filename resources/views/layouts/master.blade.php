                    ...
                    <div class="col-md-6">
                        <div class="header-right d-flex justify-content-end">
                            ...
                            <div class="login-register">
                                <ul>
                                    <li><a href="{{ route('login') }}" style="background: none !important;color:black;">@lang('home.SIGN_IN')</a></li>
           ...
           <nav class="navbar navbar-expand-md navbar-light navbar-laravel " style="    margin-top: -14px;">
                           ...
                           $getdata=DB::table('users')->where('id', $AuthCjchk)->Select('type')->get();
                               switch ($getdata[0]->type) {
                                   case 'teacher':?>
                                        ...
                                        <li><a style="background: none !important;color:black;">
                                            <span><a class="no-styleing" href="{{route('teacherHome')}}"> {{Auth::user()->fname}}</span></a></li>
                                            <div class="dropdown">
                                        <i class="fa fa-cog" aria-hidden="true"></i>
                                        <div class="dropdown-content">
                                        <p><a style="color: black" href="{{route('teacher_edit_profile')}}">@lang('home.Edit_Profile')</a></p>
                              ...
                              case 'student':?>
                                                    <ul>
                                        <li><a style="background: none !important;color:black;">
                                            <span><a class="no-styleing" href="{{route('studentHome')}}"> {{Auth::user()->fname}}</span></a></li>
                                            <div class="dropdown">
                                        <i class="fa fa-cog" aria-hidden="true"></i>
                                        <div class="dropdown-content">
                                        <p><a style="color: black" href="{{route('student_edit_profile')}}">@lang('home.Edit_Profile')</a></p>
                                   <form method="post" action="{{route('logout')}}">
                                                    @csrf
                                                    <button class="btn-sm btn-outline-primary">logout</button>
                                                </form>
                                ...
                                <ul class="navbar-nav ml-auto">
                                 <li class="nav-item">
                                    ...
                                    <li>
                                      ...
                                      <li>
                                        <a href="{{route('donate')}}" style="background-color: #ffc10e;padding: 12px 40px 12px 40px;margin: 19px 2px 2px 2px;color: white;border-radius: 6px;color:#000000;">Donate</a>
                                    </li>
                                </ul>
